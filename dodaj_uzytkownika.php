...
<body id="page-top">
	...
	<br>
					<h1>Panel dodawania nowego użytkownika</h1>
					<h2>Jeżeli chcesz dodać nowego użytkownika, wypełnij poniższe pola i kliknij przycisk.</h2>
							
						<form method="POST" action="dodaj_uzytkownika.php#main">
							...
							<input type="submit" value="Dodaj użytkownika" name="dodaj_uzytk">
						</form>
