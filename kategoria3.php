...
<head>
    ...
    <title>E-learning - kategorie</title>
...
<body id="page-top">
	...
	if($_SESSION['zalogowani']==true)
	{
		...
		//{
			//echo $styl_uczenia2;
			$wstaw = "UPDATE uzytkownicy SET sposob_uczenia = 'dzialaniowiec' WHERE login = '$login'";
		...
		$query = "SELECT id_kategorii,temat FROM kategorie ORDER BY id_kategorii";
		...
		if ($result->num_rows > 0) 
		{
			...
			//echo '<div class="box">';
				...
				//echo "<table>"; 
				//echo "<tr>";
				echo "<b>KATEGORIA ".$row['id_kategorii']." - </b>";
				//echo "</tr>"; 
				//echo "<tr>";
				echo "<b>".$row['temat']." - </b>";
				//echo "</tr>"; 
				//echo "<tr>";
				echo'<a href=\'lekcja3.php\' class="button style3 fit" data-poptrox="youtube,300x400">Przejdź</a>';
				//echo "</tr>";
			//echo "</table>"; 
			echo '</div>';
			echo '</div>';
