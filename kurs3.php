...
<head>
    ...
    <title>E-learning - kursy działaniowiec</title>
...
/******* No need to edit below this line *********/
    ...
    jQuery(document).ready(function($){
        ...
        function endQuiz(){
			...
			+ '<a href="sluchowiec.php">Słuchowiec</a>' + '<br><a href="wzrokowiec.php">Wzrokowiec</a><br>';
		...
		echo'<br><br><div id="dodaj_kom">
			<form name="dodaj_komentarz" method="post" action="dodaj_komentarz3.php">
		...
		{	
			...
			<br><br>
			<form name="usun_komentarz" method="post" action="usun_komentarz3.php">
...
$sql1 = "SELECT tresc FROM kursy WHERE id_kursu = 3";
...
<br><br><br><center><a href="dzialaniowiec.php" class="button style3 fit" data-poptrox="youtube,300x400">POWRÓT</a></center>
<hr>
<br>
</div>  
