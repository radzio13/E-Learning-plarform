	         ...
	         $is_correct = 0;
	          ...
	          if($insert_row){
	            continue;
	      		...
	      		die("Błąd: (".$mysqli->errno.") ".$mysqli->eerror);
	    	}
        }
    }
   $msg="Pytanie zostało dodane";
}
}
//get total questions
...
<main>
	<div class="container">
	     ...
	     ?>
	     <form method="post" action="dodaj_pytania.php">
	     	   <p>
			...
			<input type="text" name="choice5" />
	     	   ...
	     	   <p>
			<label>Numer poprawnej odpowiedzi </label>
	...
	if($_SESSION['zalogowani']==true)
	{
		...
		if ($result->num_rows > 0) 
		{
			...
			{
				echo "<tr>";
				echo "<td><b>".$row['question_number']."</b></td>";
				echo "<td><b>".$row['question']."</b></td>";
				echo "</tr>"; 
			}
			echo "</table>"; 
