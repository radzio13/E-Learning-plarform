...
<head>
    ...
    <title>E-learning - usuń lekcje</title>
...
<body id="page-top">
	...
	<div id="main">
			...
			<br>
					<h1>Panel usuwania lekcji</h1>
					<h2>Jeżeli chcesz usunąć lekcję, wypełnij poniższe pola i kliknij przycisk.</h2>
							
						<form method="POST" action="usun_lekcje.php#main">
							Podaj ID lekcji:<br><input type="text" name= "id_kursu" maxlength="3"/><br><br>
							Podaj temat lekcji:<br><input type="text" name= "temat"/><br><br>
							<input type="submit" value="Usuń lekcję" name="usun_kurs">
						</form>
			...
			<?php
				...
				if(mysqli_num_rows($result2) != 0)
				{
						...
						else echo "Nie wpisałeś ID lub tematu lekcji!";
				}
				  else echo " Podana lekcja nie istnieje!";
				}
				?>
