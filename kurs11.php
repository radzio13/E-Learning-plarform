...
<body id="page-top">
    ...
    <div id="container">
      ...
      <main>
      <div class="container">
        <h2>Sprawdź poziom zdobytej wiedzy</h2>
	<ul>
		<li><strong>Liczba pytań: </strong><?php echo $total2; ?></ul>
		<li><strong>Typ: </strong>Wielokrotny wybór</ul>
		<li><strong>Przewidywany czas: </strong><?php echo $total2*0.5; ?> minut</ul>
	</ul><br>
	<a href="kurs111.php?n=1" class="start">ZACZNIJ</a>
      </div>
    </div>
