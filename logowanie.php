...
<head>
    ...
    <title>E-learning - logowanie</title>
...
<body id="page-top">
    ...
    <section id="services">
        <div class="login-card" id="log"><img class="profile-img-card" src="assets/img/avatar_2x.png">
            <p class="profile-name-card"> </p>
							<form action="zaloguj.php" method= "post">
							Podaj login:<br><input type="text" name= "Login"/><br><br>
							Podaj hasło:<br><input type="password" name= "Haslo"/><br><br>
							<center><input class="btn btn-primary" type="submit" value= "Zaloguj się"/></center>
						</form>
						<?php
						if(isset($_SESSION['blad']))
							echo $_SESSION['blad'];
						?>
						<br><center><a href="index.html" class="button style3 fit" data-poptrox="youtube,300x400">POWRÓT</a></center>
		</div>
    </section>
