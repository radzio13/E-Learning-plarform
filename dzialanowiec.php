...
<body id="page-top">
	...
	if($_SESSION['zalogowani']==true)
	{
		...
		//{
			//echo $styl_uczenia2;
			$wstaw = "UPDATE uzytkownicy SET sposob_uczenia = 'dzialanowiec' WHERE login = '$login'";
		...
		$query = "SELECT id_kursu,temat FROM kursy WHERE sposob=3 ORDER BY id_kursu";
		...
		if ($result->num_rows > 0) 
		{
			...
			echo "<table>"; 
			echo "<tr>";
			echo '<td><a class="image fit"><img src="img/pic01.jpg" alt="" /></a></td>';
			echo "</tr>";
				echo "<tr>";
				echo "<td><b>LEKCJA ".$row['id_kursu']."</b></td>";
				echo "</tr>"; 
				echo "<tr>";
				echo "<td><b>".$row['temat']."</b></td>";
				echo "</tr>"; 
				echo "<tr>";
				echo'<td><br><br><a href=\'kurs'.$row['id_kursu'].'.php\' class="button style3 fit" data-poptrox="youtube,300x400">Rozpocznij</a></td>';
				echo "</tr>";
			echo "</table>"; 
