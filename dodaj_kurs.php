...
<body id="page-top">
	...
	<div id="main">
			...
			<br>
					<h1>Panel dodawania nowego kursu</h1>
					<h2>Jeżeli chcesz dodać nowy kurs, wypełnij poniższe pola i kliknij przycisk.</h2>
							
						<form method="POST" action="dodaj_kurs.php#main">
							Podaj temat kursu:<br><input type="text" name= "temat"/><br><br>
							<input type="submit" value="Dodaj kurs" name="dodaj_kurs">
						</form>
	...
	<?php
		...
		$sql = "SELECT temat FROM lekcje WHERE temat='$temat'";
		...
		if(mysqli_num_rows($result) == 0)
		{
				...
				{ 
					...
					$query = "INSERT INTO lekcje (temat)  VALUES ('$temat')";
					$result = mysqli_query($mysqli, $query);

					 echo "Kurs został pomyślnie dodany!";
				}
				else echo "Nie wpisałeś tematu lub treści kursu lub sposobu nauczania!";
		}
