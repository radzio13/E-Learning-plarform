...
<body id="page-top">
	...
	if($_SESSION['zalogowani']==true && $_SESSION['stanowisko']=='Admin' || $_SESSION['stanowisko']=='Moderator')
	{
		...
		$query = "SELECT * FROM komentarze WHERE zatwierdzony = 0 ORDER BY id_komentarza DESC";
		...
		if ($result->num_rows > 0) 
		{
			...
			echo "<h2>Komentarze oczekujące na akceptację przez administratora:</h2>";
		...
		if($_SESSION['stanowisko']=='Admin' || $_SESSION['stanowisko']=='Moderator')
		{	
			echo'<div id="zatwierdz_kom">
			<br><br>
			<form name="zatwierdz_komentarz" method="post" action="zatwierdz_komentarz.php">
			<h3>Formularz zatwierdzania komentarzy:</h3>
			Podaj ID komentarza, który chcesz zatwierdzić: <br>
			<input name="Id_komentarz_zatw" type="text" size="30" maxlength="3"><br>
			<br>
			<input value="Zatwierdź komentarz" type="submit">
			</form>
			<br>
			</div>
			';
				if(isset($_SESSION['zatwierdzono_komentarz']))
				{	
					echo $_SESSION['zatwierdzono_komentarz'];
					unset($_SESSION['zatwierdzono_komentarz']);
				}
				if(isset($_SESSION['puste_zatwierdz_komentarz']))
				{	
					echo $_SESSION['puste_zatwierdz_komentarz'];
					unset($_SESSION['puste_zatwierdz_komentarz']);
				}
				if(isset($_SESSION['blad_zatwierdz_komentarz']))
				{
					echo $_SESSION['blad_zatwierdz_komentarz'];
					unset($_SESSION['blad_zatwierdz_komentarz']);
				}
