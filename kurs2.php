...
<head>
    ...
    <title>E-learning - kursy słuchowiec</title>
...
<body id="page-top">
	...
	if($_SESSION['zalogowani']==true)
	{
		...
		$query1 = "SELECT tresc FROM kursy WHERE id_kursu = 2";
...
/******* No need to edit below this line *********/
    ...
    jQuery(document).ready(function($){
        ...
        function endQuiz(){
			...
			+ '<a href="wzrokowiec.php">Wzrokowiec</a>' + '<br><a href="dzialaniowiec.php">Działaniowiec</a><br>';
		...
		$query = "SELECT * FROM komentarze WHERE id_kursu = 2 AND zatwierdzony = 1 ORDER BY id_komentarza";
		...
		$sql2  = "SELECT ocena FROM oceny WHERE id_kursu = 2";
		...
		echo'<br><br><div id="dodaj_kom">
			<form name="dodaj_komentarz" method="post" action="dodaj_komentarz2.php">
		...
		{	
			...
			<br><br>
			<form name="usun_komentarz" method="post" action="usun_komentarz2.php">
...
$sql1 = "SELECT tresc FROM kursy WHERE id_kursu = 2";
...
<form name="edycja_lekcji" method="post" action="kurs2.php">
       <table>
			...
			<input value="Edycja lekcji" type="submit" name="edycja_lekcji">
				...
				if (isset($_POST['edycja_lekcji']))
				{
					...
					$zapisanatresc = $_POST['zapisanatresc'];
							...
							$query = "UPDATE kursy SET tresc = '$zapisanatresc' where id_kursu =2";
...
<br><br><br><center><a href="sluchowiec.php" class="button style3 fit" data-poptrox="youtube,300x400">POWRÓT</a></center>
<hr>
<br>
</div>  
