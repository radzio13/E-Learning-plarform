...
<head>
    ...
    <title>E-learning - lekcje wzrokowiec</title>
...
<body id="page-top">
	...
	<div id="main">
			...
			<br>
					<h1>Panel dodawania nowej lekcji</h1>
					<h2>Jeżeli chcesz dodać nową lekcję, wypełnij poniższe pola i kliknij przycisk.</h2>
							
						<form method="POST" action="dodaj_lekcje.php#main">
							Podaj temat lekcji:<br><input type="text" name= "temat"/><br><br>
							Wpisz treść lekcji:<br><input type="text" name= "tresc"/><br><br>
							Wpisz numer sposobu nauczania (1 - wzrokowiec, 2 - słuchowiec, 3 - działaniowiec):
							<br><input type="text" name= "sposob" maxlength="1"/><br><br>
							<input type="submit" value="Dodaj lekcję" name="dodaj_kurs">
						</form>
	...
	if($_SESSION['zalogowani']==true)
	{
		...
		if ($result->num_rows > 0) 
		{
			...
			echo "<td><b>SPOSÓB NAUCZANIA</b></td>";
			echo "<td><b>DATA DODANIA</b></td>";
			echo "</tr>";
			while($row = $result->fetch_assoc()) 
			{
				echo "<tr>";
				echo "<td><b>".$row['id_kursu']."</b></td>";
				echo "<td><b>".$row['temat']."</b></td>";
				echo "<td><b>".$row['sposob']."</b></td>";
