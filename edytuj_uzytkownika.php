...
<body id="page-top">
	...
	<br>
					<h1>Panel edycji użytkownika</h1>
					<h2>Jeżeli chcesz edytować użytkownika, wypełnij poniższe pola i kliknij przycisk.</h2>
							
						<form method="POST" action="edytuj_uzytkownika.php#main">
							...
							<input type="submit" value="Edytuj użytkownika" name="edytuj_uzytk">
						</form>
			...
			<?php
				...
				if(mysqli_num_rows($result) != 0)
				{
						...
						{ 
							...
							$query = "UPDATE uzytkownicy SET haslo ='$haslo1' WHERE login='$login'";
							$result = mysqli_query($mysqli, $query);

							echo "Konto zostało edytowane!";
						}
